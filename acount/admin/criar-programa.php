					...
					<div class="panel-body">
						<form id="form-criar-programa" class="form-horizontal" action="/acount/admin/criar_programa.php" method="post">
                            <div class="form-group" id="div-programa-tipo" >
                                ...
                                <div class="col-md-9">
                                <select id="programa-tipo" name="programa-tipo" 
                                class="form-control" title="Escolha o Tipo" >
                            ...
                            <div class="form-group" id="div-nome-curso" >
                                ...
                                <div class="col-md-9">
                                    ...
                                    placeholder="Digite o Nome do Curso" title="Entre com o Nome do Curso" autofocus/>
                                </div> <!-- col-md-9 -->
                            </div> <!-- nome-curso -->
                            ...
                            <div class="form-group">
                                <div id="div-btn-programa-enviar" class="col-md-12 widget-right">
